...
def video_predict(video_url, weights=None, config=None,
                  dict_path=None, device=None,
    ...
    """
    # Default paths for Windows if not provided
    if config is None or dict_path is None:
